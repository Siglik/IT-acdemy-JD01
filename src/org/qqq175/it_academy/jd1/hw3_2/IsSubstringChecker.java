...
public class IsSubstringChecker {
	...
	System.out.println("Is \"" + someString + "\" are cycle shift of \"" + anotherString + "\":  "
		+ isSubstring(someString, anotherString));
    }
	...
	if (str1.length() != str2.length()) { // check lengths
	    ...
	    /*
	     * find first chars (substring) of str1 equal to some str2
	     * substring, start from one char
	     */
	    while (str2.indexOf(str1.substring(0, length)) != -1) {
	    ...
	    /* search last part of str1 in str2 - if found - result is true */
	    result = (str2.indexOf(str1.substring(length - 1, str1.length())) != -1);
	}
	return result;
    }
}